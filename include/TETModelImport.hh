...
{
public:
 TETModelImport(G4bool isAF, G4UIExecutive* ui, G4String csvbodies="../scene/bodies.csv");
 TETModelImport(G4bool isAF, G4bool isICRP145, G4UIExecutive* ui);
...
private:
 ...
 std::map<std::string, std::pair<bool, bool>> bodies;
